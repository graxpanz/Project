<div class="card shadow">
    ...
    <form action="/promotion/insert" method="POST" enctype="multipart/form-data">
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                <div class="col col-md-6 px-1 px-md-5 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="ชื่อโปรโมชั่น" required>
                    </div>
                    <div class="form-group">
                        <label for="code">โค้ดส่วนลด</label>
                        <input type="text" class="form-control" name="code" id="code" placeholder="โค้ดส่วนลดอย่างน้อย 6 ตัว" minlength="6" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col col-md-6 px-1 px-md-5 mt-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="discount" id="discount" placeholder="ส่วนลด" min="0.00" step="1.00" required>
                    </div>
                    <div class="form-group">
                        <label for="start_datetime">วันที่เริ่มโปรโมชั่น</label>
                        <input type="datetime-local" class="form-control" name="start_datetime" id="start_datetime" placeholder="วันที่เริ่มโปรโมชั่น" required>
                    </div>
                    <div class="form-group">
                        <label for="end_datetime">วันที่สิ้นสุดโปรโมชั่น</label>
                        <input type="datetime-local" class="form-control" name="end_datetime" id="end_datetime" placeholder="วันที่สิ้นสุดโปรโมชั่น" required>
                    </div>
                    <div class="form-group">
