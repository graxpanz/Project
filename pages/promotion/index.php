                        ...
                        <div class="col-12">
                            <div class="card shadow">
                                <div class="card-header border-0 pt-4">
                                    ...
                                    <a href="add_promotion.php" class="btn btn-primary mt-3">
                                ...
                                <div class="card-body">
                                    <table id="logs" class="table table-hover" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $num = 0;
                                            $filteredPromotions = isset($_GET['promotion_id']) && $_GET['promotion_id'] !== ''
                                                ? array_filter($promotion, function ($promotion) {
                                                    return $promotion['promotion_id'] == $_GET['promotion_id'];
                                                })
                                                : $promotion;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type='button' class='btn btn-danger delete-btn'
                                                            data-id='<?php echo $promotion['promotion_id']; ?>'>
                    ...
                    $(document).on('click', '.delete-btn', function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = `delete_promotion.php?promotion_id=${promotion_id}`;
                            }
                        });
